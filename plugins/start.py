...
from bot import Bot
from config import ADMINS, FORCE_MSG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, REQUEST_CHANNEL1, REQUEST_CHANNEL2, START_PIC
...
async def send_text(client: Bot, message: Message):
    if message.reply_to_message:
        ...
        pls_wait = await message.reply("<i>Broadcasting Message.. ItnA Apni Gand Marao</i>")
