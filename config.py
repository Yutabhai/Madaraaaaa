...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7666853875:AAEapfWN5zdOfvpQnepIJtRVqVeknBUizbQ")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6199677027 6407720267 7050116326 5023980749 7385295244 1576425650").split()):
        ADMINS.append(int(x))
except ValueError:
